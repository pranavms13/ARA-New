    ...
    return (
        <View style={styles.container}>
            <ImageBackground source={require('../assets/Aadhaar_Background.png')} style={styles.image}>
                <Image source={require('../assets/Resident_app_logo.png')} style={styles.logo} />
                <View style={{ paddingTop: '12%', paddingHorizontal: '8%' }}>
                    <Text style={styles.headingtext}>{`Welcome to\nAadhaar Resident App`}</Text>
                    ...
                    <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate("VerificationScreen") }}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1 }}>
                                <Image source={require('../assets/verification.png')} style={{ width: 60, height: 60 }} />
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
    ...
    return (
        <NavigationContainer independent={true}>
            <Stack.Navigator screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="VerificationScreen" component={VerificationScreen} initialParams={{ prenav: navigation }}/>
            </Stack.Navigator>
